...
<div class="content">
    ...
    <div class="mainbar">
        ...
        <div class="matter">
            <div class="container">
                <form class="form-horizontal" role="form" action="/managestudentsservlet" method="post" id="formMain">
                    <input type="hidden" id="hidOperationType" name="hidOperationType" />
                    <input type="hidden" id="hidStudentId" name="hidStudentId" value="${ modifyStudent.studentId }" />
                        ...
                        <div class="col-md-12">
                            <div class="widget wgreen">
                                <div class="widget-head">
                                    <div class="pull-left">
                                        <c:if test="${ empty modifyStudent }">学生信息添加</c:if>
                                        <c:if test="${ not empty modifyStudent }">学生信息修改</c:if>
                                        <span class="label label-danger" id="spanMessage">${requestScope.message}</span>
                                    </div>
                                    <div class="widget-icons pull-right">
                                        <c:if test="${ empty modifyStudent }"><a href="#" class="wminimize"><i class="icon-chevron-down"></i></a></c:if>
                                        <c:if test="${ not  empty modifyStudent }"><a href="#" class="wminimize"><i class="icon-chevron-up"></i></a></c:if>
                                        <a href="#" class="wclose"><i class="icon-remove"></i></a>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>

                                <div class="widget-content"  <c:if test="${ empty modifyStudent }">style="display: none"</c:if>>
                                    <div class="padd">
                                        <div class="form-group">
                                            <label class="col-lg-4 control-label">学生学号:</label>
                                            <div class="col-lg-4">
                                                <input type="text" class="form-control" name="txtNumber" id="txtNumber" value="${ modifyStudent.number }">
                                                <span class="label label-danger" id="spanNumber"></span>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-lg-4 control-label">学生名称:</label>
                                            <div class="col-lg-4">
                                                <input type="text" class="form-control" name="txtName" id="txtName" value="${ modifyStudent.name }">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <input type="date" class="form-control" name="txtBirthday" id="txtBirthday" value="${ modifyStudent.birthday }">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <input type="text" class="form-control"  name="txtPhoneNumber" id="txtPhoneNumber" value="${ modifyStudent.phoneNumber }">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <input type="text" class="form-control"  name="txtAddress" id="txtAddress" value="${ modifyStudent.address }">
                                                <span class="label label-danger" id="spanAddress"></span>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-lg-4 control-label">所在的班级:</label>
                                            <div class="col-lg-4">
                                                <select name="selClazzId" class="form-control">
                                                    <option value="0"></option>
                                                    <c:forEach items="${ clazzes }" var="clazz">
                                                        <option value="${ clazz.clazzId }"
                                                                <c:if test="${ clazz.clazzId == modifyStudent.clazzId }">selected="selected"</c:if>>${ clazz.name }
                                                        </option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-lg-offset-1 col-lg-9">
                                                ...
                                                <c:if test="${ not empty modifyStudent }">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="widget wgreen">
                                <div class="widget-head">
                                    <div class="pull-left">学生信息查询</div>
                                    <div class="widget-icons pull-right">
                        ...
                        <div class="widget">
                            ...
                            <div class="widget-content">
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    <thead>
                                    <tr>
                                        <th><a href="javascript: sorting('StudentId')">序号</a></th>
                                        <th><a href="javascript: sorting('Number')">学生学号</a></th>
                                        <th><a href="javascript: sorting('Name')">学生姓名</a></th>
                                        ...
                                        <th><a href="javascript: sorting('ClazzId')">所在班级</a></th>
                                        <th>操作</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <c:forEach items="${requestScope.students}" var="student" begin="${ begin - 1 }" end = "${ end - 1 }">
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-xs btn-warning" onclick="modify(${ student.studentId })"><i class="icon-pencil"></i> </button>
                                                <button class="btn btn-xs btn-danger" onclick="remove(${ student.studentId })"><i class="icon-remove"></i> </button>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
...
<script type="text/javascript">
    ...
    function remove(studentId) {
        if (confirm("确定删除序号" + studentId + "的学生信息?")){
            let formMain = document.getElementById("formMain");
            let hidOperationType = document.getElementById("hidOperationType");
            let hidClazzId = document.getElementById("hidStudentId");
            hidClazzId.value = studentId;
    ...
    function modify(studentId) {
        let formMain = document.getElementById("formMain");
        let hidOperationType = document.getElementById("hidOperationType");
        let hidStudentId = document.getElementById("hidStudentId");
